...
def f1_01m(body):
    ...
    try:
        ...
        findable = {'name': 'RDA_F1_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return findable, 200
...
def f1_01d(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F1_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def f1_02m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F1_02M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def f1_02d(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F1_02D', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def f2_01m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F2_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def f3_01m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F3_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def f4_01m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_F4_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def a1_01m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_A1_01M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def a1_02m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_A1_02M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def a1_02d(body):
    ...
    try:
        ...
        result = {'name': 'RDA_A1_02D', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def a1_03m(body):
    ...
    try:
        ...
        result = {'name': 'RDA_A1_03M', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def a1_03d(body):
    ...
    try:
        ...
        result = {'name': 'RDA_A1_03D', 'msg': msg, 'points': points, 'color': eva.get_color(points) }
        return result, 200
    except Exception as e:
        return None, 201
...
def all(body):
  ...
  try:
    #Accessible tests
    points, msg = eva.rda_a1_01m()
    accessible.update({'rda_a1_01m': {'name': "RDA_A1_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_01m')
    points, msg = eva.rda_a1_02m()
    accessible.update({'rda_a1_02m': {'name': "RDA_A1_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_02m')
    points, msg = eva.rda_a1_02d()
    accessible.update({'rda_a1_02d': {'name': "RDA_A1_02D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_02d')
    points, msg = eva.rda_a1_03m()
    accessible.update({'rda_a1_03m': {'name': "RDA_A1_03M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_03m')
    points, msg = eva.rda_a1_03d()
    accessible.update({'rda_a1_03d': {'name': "RDA_A1_03D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_03d')
    points, msg = eva.rda_a1_04m()
    accessible.update({'rda_a1_04m': {'name': "RDA_A1_04M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_04m')
    points, msg = eva.rda_a1_04d()
    accessible.update({'rda_a1_04d': {'name': "RDA_A1_04D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_04d')
    points, msg = eva.rda_a1_05d()
    accessible.update({'rda_a1_05d': {'name': "RDA_A1_05D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_05d')
    points, msg = eva.rda_a1_1_01m()
    accessible.update({'rda_a1_1_01m': {'name': "RDA_A1.1_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_1_01m')
    points, msg = eva.rda_a1_1_01d()
    accessible.update({'rda_a1_1_01d': {'name': "RDA_A1.1_01D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_1_01d')
    points, msg = eva.rda_a1_2_01d()
    accessible.update({'rda_a1_2_01d': {'name': "RDA_A1.2_02D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_a1_2_01d')
    points, msg = eva.rda_a2_01m()
    accessible.update({'rda_a2_01m': {'name': "RDA_A2_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
  ...
  try:
    ...
    interoperable = {}
    points, msg = eva.rda_i1_01m()
    interoperable.update({'rda_i1_01m': {'name': "RDA_I1_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i1_01m')
    points, msg = eva.rda_i1_01d()
    interoperable.update({'rda_i1_01d': {'name': "RDA_I1_01D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i1_01d')
    points, msg = eva.rda_i1_02m()
    interoperable.update({'rda_i1_02m': {'name': "RDA_I1_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i1_02m')
    points, msg = eva.rda_i1_02d()
    interoperable.update({'rda_i1_02d': {'name': "RDA_I1_02D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i1_02d')
    points, msg = eva.rda_i2_01m()
    interoperable.update({'rda_i2_01m': {'name': "RDA_I2_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i2_01m')
    points, msg = eva.rda_i2_01d()
    interoperable.update({'rda_i2_01d': {'name': "RDA_I2_01D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i2_01d')
    points, msg = eva.rda_i3_01m()
    interoperable.update({'rda_i3_01m': {'name': "RDA_I3_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i3_01m')
    points, msg = eva.rda_i3_01d()
    interoperable.update({'rda_i3_01d': {'name': "RDA_I3_01D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i3_01d')
    points, msg = eva.rda_i3_02m()
    interoperable.update({'rda_i3_02m': {'name': "RDA_I3_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i3_02m')
    points, msg = eva.rda_i3_02d()
    interoperable.update({'rda_i3_02d': {'name': "RDA_I3_02D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i3_02d')
    points, msg = eva.rda_i3_03m()
    interoperable.update({'rda_i3_03m': {'name': "RDA_I3_03M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_i3_03m')
    points, msg = eva.rda_i3_04m()
    interoperable.update({'rda_i3_04m': {'name': "RDA_I3_04M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
  ...
  try:
    ...
    reusable.update({'rda_r1_01m': {'name': "RDA_R1_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_01m')
    points, msg = eva.rda_r1_1_01m()
    result_points = result_points + points
    reusable.update({'rda_r1_1_01m': {'name': "RDA_R1.1_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_1_01m')
    points, msg = eva.rda_r1_1_02m()
    result_points = result_points + points
    reusable.update({'rda_r1_1_02m': {'name': "RDA_R1.1_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_1_02m')
    points, msg = eva.rda_r1_1_03m()
    result_points = result_points + points
    reusable.update({'rda_r1_1_03m': {'name': "RDA_R1.1_03M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_1_03m')
    points, msg = eva.rda_r1_2_01m()
    result_points = result_points + points
    reusable.update({'rda_r1_2_01m': {'name': "RDA_R1.2_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_2_01m')
    points, msg = eva.rda_r1_2_02m()
    result_points = result_points + points
    reusable.update({'rda_r1_2_02m': {'name': "RDA_R1.2_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_2_02m')
    points, msg = eva.rda_r1_3_01m()
    result_points = result_points + points
    reusable.update({'rda_r1_3_01m': {'name': "RDA_R1.3_01M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_3_01m')
    points, msg = eva.rda_r1_3_01d()
    result_points = result_points + points
    reusable.update({'rda_r1_3_01': {'name': "RDA_R1.3_01D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_3_01')
    points, msg = eva.rda_r1_3_02m()
    result_points = result_points + points
    reusable.update({'rda_r1_3_02m': {'name': "RDA_R1.3_02M" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
    print("Test %s performed" % 'rda_r1_3_02m')
    points, msg = eva.rda_r1_3_02d()
    result_points = result_points + points
    reusable.update({'rda_r1_3_02d': {'name': "RDA_R1.3_02D" , 'msg': msg, 'points': points, 'color': eva.get_color(points) }})
...
def get(name):
    findable = {'name': name, 'msg': "Test %s has been performed" % name, 'points': 100, 'color': "#2ECC71"}
    return findable
